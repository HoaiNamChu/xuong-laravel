                                    ...
                                    <div class="swiper-wrapper">
                                        @foreach($product->galleries as $gallery)
                                            <div class="swiper-slide">
                                                <img
                                                    src="{{ \Illuminate\Support\Facades\Storage::url($gallery->product_gallery_image) }}"
                                                    alt=""
                            ...
                            <div class="mt-xl-0 mt-5">
                                        ...
                                        <div class="p-2 border border-dashed rounded">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h5 class="mb-0">{{ $product->product_quantity }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    @foreach($attributes as $attribute)
                                        @if($attribute->product_attribute_name == 'Size')
                                            <div class="col-xl-6">
                                                <div class="mt-4">
                                                    <h5 class="fs-14">Sizes :</h5>
                                                    <div class="d-flex flex-wrap gap-2">
                                                        @foreach($attributeValues as $attributeValue)
                                                            @if($attributeValue->product_attribute_id == $attribute->id)
                                                                <div data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        for="productsize-radio2">{{ $attributeValue->product_attribute_value_name }}</label>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                    </div>
                                        ...
                                        @elseif($attribute->product_attribute_name == 'Color')
                                            <div class="col-xl-6">
                                                <div class=" mt-4">
                                        ...
                                        @else
                                            <div class="col-xl-6">
                                                <div class=" mt-4">
                                                    <h5 class="fs-14">{{ $attribute->product_attribute_name }}</h5>
                                                    <div class="d-flex flex-wrap gap-2">
                                                        @foreach($attributeValues as $attributeValue)
                                                            @if($attributeValue->product_attribute_id == $attribute->id)
                                                                <div data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                            ...
                                                            <div class="border border-dashed rounded p-3">
                                                                ...
                                                                <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                    <a href="#" class="d-block">
                                                                        <img
                                                                            src="{{ asset('theme/admin/assets/images/small/img-12.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-fit-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img
                                                                            src="{{ asset('theme/admin/assets/images/small/img-11.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-fit-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img
                                                                            src="{{ asset('theme/admin/assets/images/small/img-10.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-fit-cover">
                                                                    </a>
                                                                </div>
